    ...
    Column(
        ...
        when (val stateValue = state.value) {
            ...
            is DollarViewModel.DollarUIState.Success -> {
                ...
                Row {
                    Text("Compra: ")
                    Text(stateValue.data.compraOfficial.toString())
                }
                Row {
                    Text("Venta: ")
                    Text(stateValue.data.ventaOfficial.toString())
                }
                Text(
                ...
                Row {
                    Text("Compra: ")
                    Text(stateValue.data.compraParallel.toString())
                }
                Row {
                    Text("Venta: ")
                    Text(stateValue.data.ventaParallel.toString())
                }
                Text(
                    text="Ultima actualizacion: ",
                    style= MaterialTheme.typography.titleLarge
                )
                Text(Date(stateValue.data.fechaActualizacion).toString())
            }
        }
    }
}